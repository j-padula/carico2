...
.badge-neutral { display:inline-block; padding:1px 7px; border-radius:10px;
    ...
    for i, pkg in enumerate(packages_plan):
        ...
        with col:
            st.markdown(
                ...
                f'padding:6px 10px;border-radius:4px;background:rgba(0,0,0,.03);margin-bottom:4px;">'
